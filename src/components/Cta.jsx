...
const Cta = () => {
  return (
    <section className='md:py-0  relative overflow-hidden'>
      <div className="absolute w-full md:h-[60%] h-full bottom-0 left-0 bg-orange-500 "></div>
          ...
          <div className="  grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3">
            <div className='lg:col-span-2 col-span-1 space-y-3 relative top-[50%] ' >
              ...
              <EnquiryNow >
                ...
                <Button className={"bg-white h-8 text-black hover:bg-green-500"}>Enquire Now</Button>
              </EnquiryNow>

        ...
        <div className="bg-oragne-500">
          ...
          <div className="  grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3">
            <div className='lg:col-span-2 col-span-1 space-y-3 relative top-[50%] ' >
              <div data-aos="fade-top"  data-aos-duration="3000" className="flex  items-center gap-2  G   ">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-white font-semibold text-sm md:text-base">
                  Your Growth, Our Commitment
                </span>
              </div>
              <h2 data-aos="fade-right"  data-aos-duration="1000" className="text-2xl lg:text-4xl  font-bold   ">

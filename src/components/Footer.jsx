...
const Footer = () => {
    return (
        <footer className="text-white bg-black body-font">
            <div className="container   pt-15 pb-20 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">

                <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1   -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <div className=" md:ps-10 lg:col-span-2  shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        ...
                        <p className="my-5  text-white flex  gap-2 "> <IoLocationSharp className='flex-nowrap size-10 text-green-500 ' /> <span> IGCSM
                    ...
                    <div className="md:ps-10 ">
                        <h2 className="title-font font-medium text-orange-500 tracking-widest text-2xl mb-3">Quick Link</h2>
                        <nav className="list-none mb-10">

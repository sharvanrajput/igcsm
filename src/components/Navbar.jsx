                    ...
                    <div className="flex items-center justify-between py-1">
                        ...
                        <div className=" ">
                            ...
                            <div className='hidden lg:flex items-center justify-end '>
                                <Link to="/Student-login" target="_blank"
                                ...
                                <div>
                                    ...
                                    {activeDropdown === 'ADMISSION' && (
                                        <div className="pl-3 py-2 space-y-1   animate-slideDown">
                                            <Link to="/student" className="block px-4 py-2 text-gray-600 hover:text-orange-600 text-sm">Online Admission </Link>

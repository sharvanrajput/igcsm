        ...
        <section className='py-30'>
            <div className="container">
                ...
                <div className="space-y-5">
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>1. Collection of Your Information</h2>
                    ...
                    <p>If you enrol into our Loyalty Program, we will collect and store your personal information such as name, contact number, email address, communication address, date of birth, gender, zip code, lifestyle information, demographic and work details which is provided by you to INDIRA GANDHI COMPUTER SAKSHARTA MISSION(IGCSM) or a third-party business partner that operates online/offline establishments or platforms where you can earn rewards for purchase of goods and services, and redeem rewards. We will also collect your information related to your transactions on INDIRA GANDHI COMPUTER SAKSHARTA MISSION(IGCSM) platform and such third-party business partner platforms. When such third-party business partner collects your personal information directly from you, you will be governed by their privacy policies. INDIRA GANDHI COMPUTER SAKSHARTA MISSION(IGCSM) shall not be responsible for the third-party business partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.</p>
                    <p>INDIRA GANDHI COMPUTER SAKSHARTA MISSION(IGCSM) has onboarded certain third-party business partners on the Platform who specialise in the categories like travel ticket reservations, booking online movie tickets, paying online bills and more (Ultra-Partners). If you use the services of Ultra-Partners, you will be redirected to Ultra-Partners websites/applications and your entry to Ultra-Partners websites/applications will be based on your INDIRA GANDHI COMPUTER SAKSHARTA MISSION(IGCSM) login credentials after seeking your permissions to share the data further. INDIRA GANDHI COMPUTER SAKSHARTA MISSION(IGCSM) shall not be responsible for the Ultra-Partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.</p>
                    <h2 className='py-2 text-2xl font-semibold '>2. Use of Demographic / Profile Data / Your Information</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>3. Cookies</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>4. Sharing of personal information</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>5. Links to Other Sites</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>6. Security Precautions</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>7. Choice/Opt-Out</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>8. Advertisements on Platform</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>9. Children Information</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>10. Data Retention</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>11. Your Consent</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>12. Changes to this Privacy Policy</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>13. Grievance Officer</h2>
                    ...
                    <h2 className='py-2 text-2xl font-semibold '>Grievance Officer</h2>

                    <p>
                        INDIRA GANDHI COMPUTER SAKSHARTA MISSION(IGCSM) , <br />
                        424, 4th Floor, DLF Prime Tower, <br />
                        Okhla Industrial Area, Phase 1, <br />
                        New Delhi 110020 <br />
                        Phone: +91-11-45640727 , +91-11-26812165 <br />
                        Email:&nbsp;<a href="mailto:director@igcsm.com">director@igcsm.com</a> <br />
                        Time: Mon - Sat (11:00 AM  - 05:00 PM)
                    </p>
                    <h2 className='py-2 text-2xl font-semibold '>14. Queries</h2>
